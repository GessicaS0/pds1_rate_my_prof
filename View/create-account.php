...
<body>
    ...
    <div class="container panel panel-default testa" style=" margin-top: 100px;">
        <div class="panel-body">
            <div class="text-center">
                <h2><b>Criar sua conta</b></h2>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="btn-group">
                                ...
                                <button class="btn btn-md btn-md2 btn-primary" type="submit">Criar Conta</button>
                            </div>
                        </div>
                </form>
        </div>
